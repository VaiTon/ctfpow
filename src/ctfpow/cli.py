...
def main():
    ...
    # create
    parser_create = subparsers.add_parser("create", help="Create a new challenge")
    ...
    # solve
    parser_solve = subparsers.add_parser("solve", help="Solve a challenge string")
    parser_solve.add_argument("challenge", type=str, help="Challenge string")
    ...
    parser_verify.add_argument("challenge", type=str, help="Challenge string")
    parser_verify.add_argument("solution", type=str, help="Solution string")
    ...
    parser_info.add_argument("challenge", type=str, help="Challenge string")
